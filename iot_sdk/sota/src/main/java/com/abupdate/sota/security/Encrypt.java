package com.abupdate.sota.security;
...
public class Encrypt {
    ...
    public static String encryptObtainProduct() {
        try {
            ...
            byte[] b = builder.append(sotaDeviceInfo.models)
                    .append(sotaDeviceInfo.deviceType)
                    .append(sotaDeviceInfo.oem)
                    .append(sotaDeviceInfo.platform)
                    .toString().getBytes();
