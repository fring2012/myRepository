...
public class MqttClient implements IMqttClient { //), DestinationProvider {
	...
	/* (non-Javadoc)
	 * @see IMqttClient#subscribe(java.lang.String, int, java.lang.Object, IMqttActionListener)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IMqttClient#subscribe(java.lang.String, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IMqttClient#getPendingDeliveryTokens()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IMqttClient#getTopic(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see IMqttClient#setCallback(MqttCallback)
	 */
	@Override
