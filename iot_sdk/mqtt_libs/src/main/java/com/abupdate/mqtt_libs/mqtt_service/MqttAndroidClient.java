...
import com.abupdate.mqtt_libs.mqttv3.IMqttMessageListener;
import com.abupdate.mqtt_libs.mqttv3.IMqttToken;
import com.abupdate.mqtt_libs.mqttv3.MqttCallback;
import com.abupdate.mqtt_libs.mqttv3.MqttCallbackExtended;
import com.abupdate.mqtt_libs.mqttv3.MqttClientPersistence;
import com.abupdate.mqtt_libs.mqttv3.MqttConnectOptions;
...
public class MqttAndroidClient extends BroadcastReceiver implements
	 ...
	 * be called.</li>
	 * <li>Waiting on the returned token {@link com.abupdate.mqtt_libs.mqttv3.MqttToken#waitForCompletion()}
	 * or</li>
     ...
     * </p>
	 * <ul>
	 * <li>Waiting on the supplied token {@link com.abupdate.mqtt_libs.mqttv3.MqttToken#waitForCompletion()}
	 * or</li>
	 * <li>Passing in a callback {@link IMqttActionListener} to this method</li>
	 * </ul>
	 * 
	 ...
	 * connect and subscribe can be tracked using the {@link com.abupdate.mqtt_libs.mqttv3.MqttToken} returned
	...
	public void stopKeepConnect() {
		mqttService.stopKeepConnect();
	}

	public boolean isKeepConnect() {
		return clientHandle == null ? false : mqttService == null ? false : mqttService.containClient(clientHandle);
	}
