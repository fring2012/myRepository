...
import com.abupdate.mqtt_libs.mqttv3.IMqttAsyncClient;
import com.abupdate.mqtt_libs.mqttv3.IMqttToken;
import com.abupdate.mqtt_libs.mqttv3.MqttException;
import com.abupdate.mqtt_libs.mqttv3.MqttSecurityException;
...
class MqttTokenAndroid implements IMqttToken {
  ...
  /**
   * @see com.abupdate.mqtt_libs.mqttv3.IMqttToken#waitForCompletion()
   */
  @Override
  ...
  /**
   * @see com.abupdate.mqtt_libs.mqttv3.IMqttToken#waitForCompletion(long)
   */
  @Override
  ...
  /**
   * @see com.abupdate.mqtt_libs.mqttv3.IMqttToken#isComplete()
   */
  @Override
  ...
  /**
   * @see com.abupdate.mqtt_libs.mqttv3.IMqttToken#getException()
   */
  @Override
  ...
  /**
   * @see com.abupdate.mqtt_libs.mqttv3.IMqttToken#getClient()
   */
  @Override
  ...
  /**
   * @see com.abupdate.mqtt_libs.mqttv3.IMqttToken#setActionCallback(IMqttActionListener)
   */
  @Override
  ...
  /**
   * @see com.abupdate.mqtt_libs.mqttv3.IMqttToken#getActionCallback()
   */
  @Override
  ...
  /**
   * @see com.abupdate.mqtt_libs.mqttv3.IMqttToken#getTopics()
   */
  @Override
  ...
  /**
   * @see com.abupdate.mqtt_libs.mqttv3.IMqttToken#setUserContext(Object)
   */
  @Override
  ...
  /**
   * @see com.abupdate.mqtt_libs.mqttv3.IMqttToken#getUserContext()
   */
  @Override
  ...
  /**
   * @see com.abupdate.mqtt_libs.mqttv3.IMqttToken#getMessageId()
   */
  @Override
